var stop, staticx; var img = new Image(); img.src = "https://gitee.com/ntaurus/blog_bed/raw/master/peach.png"; function Sakura(x, y, s, r, fn) { this.x = x; this.y = y; this.s = s; this.r = r; this.fn = fn; }
Sakura.prototype.draw = function (cxt) {
    cxt.save(); var xc = 30 * this.s / 4; cxt.translate(this.x, this.y); cxt.rotate(this.r); cxt.drawImage(img, 0, 0, 15 * this.s, 15 * this.s)
    cxt.restore();
}
