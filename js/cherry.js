var stop, staticx; var img = new Image(); img.src = "https://gitee.com/ntaurus/blog_bed/raw/master/cherry.png"; function Sakura(x, y, s, r, fn) { this.x = x; this.y = y; this.s = s; this.r = r; this.fn = fn; }
